    ...
    >
      <div style={{ display: "flex", justifyContent: "space-between", gap: 12 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 10 }}>
          ...
          <Link
            href={`/pickle-pass/sessions/${encodeURIComponent(s.id)}`}
            style={{
              borderRadius: 12,
...
export default function CrankyPickleSchedule() {
  // ✅ Hard-coded for now (until you switch to dynamic facility routes)
